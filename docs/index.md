...
- A worker who needs a simple, ongoing channel of communication with co-works

[//]: # (to get a paraphraph/anything part of the bullet - is indent 4 spaces)
    > As a quality engineer, I use the "developers" channel of  Chat to ask questions and report issues in the build 
    so that the developers get immediate feedback.
