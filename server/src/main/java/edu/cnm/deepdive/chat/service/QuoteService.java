...
// Creates a singleton
@Service
// If were running with the service profile this spring bean will be available
@Profile("service")
public class QuoteService {
  ...
  public void addQuote() {
    ...
    if (!channels.isEmpty()) {
      // Machinery we use to get the requests of the url, RestTemplate uses jackson behind the scenes
